...
export default function AddEditPartner({ pageMode = 'add' }) {
    ...
    const onSubmit = ({ partner_id }) => {
        ...
        const apiCall =
            pageMode === 'add'
                ? apis.addPartner(data)
                : apis.editPartner(location.state.state.data?.id, data);
    ...
    useEffect(() => {
        if (location.state) {
            ...
            setValue('partner_id', params.partner_id);
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                            <Typography component="h1" variant="h5" className={classes.title}>
                                {pageMode === 'add' ? 'ADD' : 'EDIT'} PARTNERS
                            </Typography>
                        </Grid>
